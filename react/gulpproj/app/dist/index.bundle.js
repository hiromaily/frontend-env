  ...
  _createClass(ColorBox, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('div', { className: 'block', style: { backgroundColor: this.state.color } }),
...
var Communicate = function (_React$Component) {
  ...
  function Communicate(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Communicate.__proto__ || Object.getPrototypeOf(Communicate)).call(this, props));
  ...
  _createClass(Communicate, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_parent2.default, null),
        _react2.default.createElement('hr', null)
      );
    }
  }]);
...
exports.default = Communicate;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./parent.jsx":4}],4:[function(require,module,exports){
(function (global){
'use strict';
  ...
  _createClass(User, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(Usercard, null),
        _react2.default.createElement('hr', null)
      );
    }
  }]);
...
User.childContextTypes = {
  favColor: _react2.default.PropTypes.string,
  ...
  _createClass(Usercard, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'usercard' },
        _react2.default.createElement(UserIcon, null),
...
var UserIcon = function (_React$Component4) {
  _inherits(UserIcon, _React$Component4);
...
//User Class
//---------------------------------------------------------
var User2 = function (_React$Component) {
  _inherits(User2, _React$Component);

  function User2(props) {
    _classCallCheck(this, User2);

    // Move the currentColor to top-level state
    var _this = _possibleConstructorReturn(this, (User2.__proto__ || Object.getPrototypeOf(User2)).call(this, props));
  ...
  _createClass(User2, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: this.swapColor.bind(this) },
          'Swap Color'
        ),
        _react2.default.createElement('hr', null)
      );
...
var _increment = require('./increment.jsx');

var _increment2 = _interopRequireDefault(_increment);

var _decrement = require('./decrement.jsx');
...
var Counter2 = function (_React$Component) {
  _inherits(Counter2, _React$Component);

  //like getInitialState()
  function Counter2(props) {
    _classCallCheck(this, Counter2);

    var _this = _possibleConstructorReturn(this, (Counter2.__proto__ || Object.getPrototypeOf(Counter2)).call(this, props));
  ...
  _createClass(Counter2, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_increment2.default, { increment: this.increment.bind(this) }),
        _react2.default.createElement(_decrement2.default, { decrement: this.decrement.bind(this) }),
        _react2.default.createElement('hr', null)
      );
    }
  }]);
...
exports.default = Counter2;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./decrement.jsx":10,"./increment.jsx":11}],9:[function(require,module,exports){
(function (global){
'use strict';
...
var Decrement = function Decrement(props) {
  return _react2.default.createElement(
    'button',
...
var Counter3 = function (_React$Component) {
  _inherits(Counter3, _React$Component);

  //like getInitialState()
  function Counter3(props) {
    _classCallCheck(this, Counter3);

    var _this = _possibleConstructorReturn(this, (Counter3.__proto__ || Object.getPrototypeOf(Counter3)).call(this, props));
  ...
  _createClass(Counter3, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(Increment, { increment: this.increment.bind(this) }),
        _react2.default.createElement(Decrement, { decrement: this.decrement.bind(this) }),
        _react2.default.createElement('hr', null)
      );
    }
  }]);
...
var Decrement = function (_React$Component) {
...
var MemoBox = function (_React$Component) {
  ...
  function MemoBox(props) {
    ...
    var _this = _possibleConstructorReturn(this, (MemoBox.__proto__ || Object.getPrototypeOf(MemoBox)).call(this, props));
    ...
    _this.chgTitle = _this.chgTitle.bind(_this);
    _this.chgDay = _this.chgDay.bind(_this);
    return _this;
  }

  _createClass(MemoBox, [{
    key: 'chgTitle',
    value: function chgTitle(event) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          'title:',
          _react2.default.createElement('input', { type: 'text', value: this.state.memo.title, onChange: this.chgTitle })
        ),
        _react2.default.createElement(
          'div',
          null,
          'day:',
          _react2.default.createElement('input', { type: 'text', value: this.state.memo.day, onChange: this.chgDay })
        ),
        _react2.default.createElement(
          _message2.default,
          { title: this.state.memo.title, day: this.state.memo.day },
...
exports.default = MemoBox;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./message.jsx":16}],15:[function(require,module,exports){
(function (global){
'use strict';
...
var _message = require('./message2.jsx');
...
var MemoBox2 = function (_React$Component) {
  _inherits(MemoBox2, _React$Component);

  //like getInitialState()
  function MemoBox2(props) {
    _classCallCheck(this, MemoBox2);

    var _this = _possibleConstructorReturn(this, (MemoBox2.__proto__ || Object.getPrototypeOf(MemoBox2)).call(this, props));
    ...
    value: function render() {
      ...
      var commentNodes = this.props.data.map(function (comment) {
        return (
          ...
          _react2.default.createElement(_message2.default, { key: comment.id, data: comment })
        );
      });
      //parent node
      return _react2.default.createElement(
...
exports.default = MemoBox2;

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./message2.jsx":17}],16:[function(require,module,exports){
(function (global){
'use strict';
...
var Message2 = function (_React$Component) {
  _inherits(Message2, _React$Component);

  function Message2() {
    _classCallCheck(this, Message2);

    return _possibleConstructorReturn(this, (Message2.__proto__ || Object.getPrototypeOf(Message2)).apply(this, arguments));
  }
...
var _newslist = require('./newslist.jsx');
    ...
    value: function loadCommentsFromServer() {
      ...
      _jquery2.default.ajax({
        ...
        success: function success(data) {
          _this2.setState({ data: data.news });
        },
    ...
    value: function render() {
      ...
      var newsNodes = this.state.data.map(function (news) {
        return (
          ...
          _react2.default.createElement(
            _newslist2.default,
            { key: news.id, date: news.date, title: news.title, author: news.author },
            news.text
          )
        );
      });
...
},{"./newslist.jsx":19,"jquery":23}],19:[function(require,module,exports){
(function (global){
'use strict';
...
var _header = require('./components/layouts/header.jsx');

var _header2 = _interopRequireDefault(_header);

var _footer = require('./components/layouts/footer.jsx');

var _footer2 = _interopRequireDefault(_footer);

var _memo_box = require('./components/memos/memo_box.jsx');

var _memo_box2 = _interopRequireDefault(_memo_box);

var _memo_box3 = require('./components/memos/memo_box2.jsx');

var _memo_box4 = _interopRequireDefault(_memo_box3);

var _timer = require('./components/timer/timer.jsx');

var _timer2 = _interopRequireDefault(_timer);

var _counter = require('./components/counter/counter.jsx');

var _counter2 = _interopRequireDefault(_counter);

var _counter3 = require('./components/counter/counter2.jsx');

var _counter4 = _interopRequireDefault(_counter3);

var _counter5 = require('./components/counter/counter3.jsx');

var _counter6 = _interopRequireDefault(_counter5);

var _news = require('./components/news/news.jsx');

var _news2 = _interopRequireDefault(_news);

var _colorbox = require('./components/colorbox/colorbox.jsx');

var _colorbox2 = _interopRequireDefault(_colorbox);

var _communicate = require('./components/communicate/communicate.jsx');

var _communicate2 = _interopRequireDefault(_communicate);

var _context = require('./components/context/context.jsx');

var _context2 = _interopRequireDefault(_context);

var _context3 = require('./components/context/context2.jsx');
...
var memoData = [{ id: 1, language: "Golang", rank: 1 }, { id: 2, language: "Python", rank: 2 }, { id: 3, language: "Javascript", rank: 3 }];
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('br', null),
        _react2.default.createElement(_memo_box2.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_news2.default, { url: '/json/news', pollInterval: 10000 }),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_colorbox2.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_communicate2.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_counter2.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_counter4.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_counter6.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_context2.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_context4.default, null),
        _react2.default.createElement('br', null),
        _react2.default.createElement(_memo_box4.default, { data: memoData }),
        _react2.default.createElement('br', null),
...
},{"./components/colorbox/colorbox.jsx":1,"./components/communicate/communicate.jsx":3,"./components/context/context.jsx":5,"./components/context/context2.jsx":6,"./components/counter/counter.jsx":7,"./components/counter/counter2.jsx":8,"./components/counter/counter3.jsx":9,"./components/layouts/footer.jsx":12,"./components/layouts/header.jsx":13,"./components/memos/memo_box.jsx":14,"./components/memos/memo_box2.jsx":15,"./components/news/news.jsx":18,"./components/timer/timer.jsx":20}],22:[function(require,module,exports){
'use strict';

var _top = require('../react/index/top.jsx');

var _top2 = _interopRequireDefault(_top);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"../react/index/top.jsx":21}],23:[function(require,module,exports){
